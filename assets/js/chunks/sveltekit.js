import {
  b8 as he,ba as pt,d as U,h as T,s as I,aU as ee,bb as gt
}
from"./runtime.js";
import {
  o as qe
...
window.fetch=(e,t)=>((e instanceof Request?e.method:t?.method||"GET")!=="GET"&&F.delete(Ae(e)),bt(e,t));
const F=new Map;
function kt(e,t) {
  const n=Ae(e,t),a=document.querySelector(n);
  if(a?.textContent) {
    a.remove();
    let {
      body:r,...i
    ...
    return o&&F.set(n,{body:r,init:i,ttl:1e3*Number(o)}),a.getAttribute("data-b64")!==null&&(r=yt(r)),Promise.resolve(new Response(r,i))
  }
  return window.fetch(e,t)
}
function St(e,t,n) {
  if(F.size>0) {
    const a=Ae(e,n),r=F.get(a);
    if(r) {
...
function Lt(e,t,n) {
  ...
  ,r=e.slice(1),i=r.filter(s=>s!==void 0);
  let o=0;
